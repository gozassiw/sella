...
export default function FAQPage() {
  return <InfoPage
    ...
    sections={[
      ...
      { heading: "How do buyers order?", body: "A buyer opens the link or Seller ID you share with them, creates a Sella account, and chooses whether to trust your store before ordering. They can create an account without trusting any store. They pay from their Sella wallet or by one-time bank transfer, then chat with you directly to arrange delivery once they've paid." },
      { heading: "Can anyone find my store, or only people I share it with?", body: "Buyers find stores through a shared link or Store ID and choose whether to add them to My Trusted Stores. Sella does not operate a public marketplace discovery feed. A blue checkmark does not change this or guarantee products, delivery or refunds." },
