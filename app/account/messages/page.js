...
export default async function BuyerMessagesPage({ searchParams }) {
  ...
  return <ChatInbox initialThreads={threads || []} userId={user.id} role="buyer" startStoreId={searchParams?.store || null} />;
}
