...
export default async function BillingPage() {
  ...
  const { data: wallet } = await supabase.from("wallets").select("available").eq("store_id", store.id).maybeSingle();
