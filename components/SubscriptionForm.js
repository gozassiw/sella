...
export default function SubscriptionForm({ storeId, plan, amount, balance = 0 }) {
  ...
  async function submit() {
    ...
    const response = await fetch("/api/subscriptions", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ storeId, plan, amount, paidWith: paymentMethod }) });
