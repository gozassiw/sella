  ...
  return (
    <AuthShell title={isResubmission ? "Update your seller onboarding" : "Complete seller onboarding"} subtitle="Sella Team reviews your store before it can go live or accept orders.">
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <section className="seller-plans-panel rounded-[26px] border border-kola/20 bg-kola-light p-5 sm:p-7" aria-labelledby="seller-plans-title">
          <div className="flex items-start justify-between gap-4"><div><p className="eyebrow text-kola">SELLER PLANS</p><h2 id="seller-plans-title" className="mt-2 text-2xl font-extrabold text-ink sm:text-3xl">Start free. Upgrade when you need more.</h2><p className="mt-3 max-w-2xl text-sm leading-6 text-kola">After approval, your store starts on the free Starter plan. Paid plans are optional upgrades for more product capacity and lower commission rates.</p></div><span className="hidden h-10 w-10 shrink-0 place-items-center rounded-2xl bg-white/70 text-kola sm:grid"><ShieldCheck size={20} /></span></div>
          <div className="mt-6 space-y-3">
            <div className="seller-plan-card seller-plan-card-start rounded-2xl border border-kola bg-white/70 p-4 sm:p-5"><div><div className="flex flex-wrap items-center gap-2"><h3 className="text-lg font-extrabold text-ink">Starter</h3><span className="rounded-full bg-kola-light px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-wide text-kola">Starts here</span></div><p className="mt-1 text-sm text-muted">Free forever · Up to 40 active products</p></div><div className="mt-3 border-t border-kola/15 pt-3 sm:mt-0 sm:border-l sm:border-t-0 sm:pl-5 sm:pt-0"><p className="text-2xl font-extrabold text-kola">3.2%</p><p className="text-xs text-muted">commission</p></div></div>
            <div className="seller-plan-card rounded-2xl border border-line bg-white p-4 sm:p-5"><div><h3 className="text-lg font-extrabold text-ink">Basic</h3><p className="mt-1 text-sm text-muted">3 months · ₦7,500</p></div><div className="mt-3 border-t border-line pt-3 sm:mt-0 sm:border-l sm:border-t-0 sm:pl-5 sm:pt-0"><p className="text-2xl font-extrabold text-kola">2.8%</p><p className="text-xs text-muted">commission</p></div></div>
            <div className="seller-plan-card rounded-2xl border border-line bg-white p-4 sm:p-5"><div><h3 className="text-lg font-extrabold text-ink">Plus</h3><p className="mt-1 text-sm text-muted">6 months · ₦14,000</p></div><div className="mt-3 border-t border-line pt-3 sm:mt-0 sm:border-l sm:border-t-0 sm:pl-5 sm:pt-0"><p className="text-2xl font-extrabold text-kola">2.6%</p><p className="text-xs text-muted">commission</p></div></div>
            <div className="seller-plan-card rounded-2xl border border-line bg-white p-4 sm:p-5"><div><h3 className="text-lg font-extrabold text-ink">Premium</h3><p className="mt-1 text-sm text-muted">12 months · ₦25,000</p></div><div className="mt-3 border-t border-line pt-3 sm:mt-0 sm:border-l sm:border-t-0 sm:pl-5 sm:pt-0"><p className="text-2xl font-extrabold text-kola">2.4%</p><p className="text-xs text-muted">commission</p></div></div>
          </div>
          <Link href="/dashboard/billing" className="mt-5 inline-flex items-center gap-2 text-sm font-extrabold text-kola underline underline-offset-4">Compare all plan benefits <ArrowRight size={16} /></Link>
        </section>
