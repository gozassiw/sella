  ...
  return (
    <AuthShell title={isResubmission ? "Update your seller onboarding" : "Complete seller onboarding"} subtitle="Sella Team reviews your store before it can go live or accept orders.">
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div className="rounded-2xl border border-kola/20 bg-kola-light p-4 text-sm leading-6 text-kola"><strong>SELLER TRIAL AND PLANS</strong><br /><span className="mt-2 block">After approval, Sella gives your store a 10-day free trial with up to 15 products. After the trial, an active paid plan is required to keep your store open, visible to buyers, and able to receive new orders.</span><span className="mt-3 block font-bold">Plans are:</span><span className="mt-2 block">Basic — 3 months — ₦7,500<br />Plus — 6 months — ₦14,000<br />Premium — 12 months — ₦25,000</span></div>
        <label className="flex items-start gap-3 rounded-2xl border border-line bg-surface p-4 text-xs leading-5 text-muted"><input type="checkbox" className="mt-1 h-4 w-4 accent-kola" checked={accepted} onChange={(event) => setAccepted(event.target.checked)} required /><span>I agree to Sella&apos;s <Link href="/seller-terms" target="_blank" className="font-bold text-kola underline">Seller Terms of Use</Link> and <Link href="/seller-privacy" target="_blank" className="font-bold text-kola underline">Seller Privacy & Anti-Piracy Policy</Link>, including the 10-day trial, paid-plan requirement, seller responsibilities, and anti-piracy rules.</span></label>
