  ...
  return (
    <AuthShell title={isResubmission ? "Update your seller onboarding" : "Complete seller onboarding"} subtitle="Sella Team reviews your store before it can go live or accept orders.">
      ...
      <form onSubmit={submit} className="space-y-6">
        ...
        <div className="rounded-2xl border border-kola/20 bg-kola-light p-4 text-sm leading-6 text-kola"><strong>SELLER PLANS</strong><br /><span className="mt-2 block">After approval, your store starts on the free Starter plan with up to 40 active product listings and no expiry. Paid plans are optional upgrades that give you more product capacity and lower commission rates.</span><span className="mt-3 block font-bold">Plans are:</span><span className="mt-2 block">Starter — Free · 40 active products · 3.2% commission<br />Basic — 3 months — ₦7,500 · 2.8% commission<br />Plus — 6 months — ₦14,000 · 2.6% commission<br />Premium — 12 months — ₦25,000 · 2.4% commission</span></div>
        <label className="flex items-start gap-3 rounded-2xl border border-line bg-surface p-4 text-xs leading-5 text-muted"><input type="checkbox" className="mt-1 h-4 w-4 accent-kola" checked={accepted} onChange={(event) => setAccepted(event.target.checked)} required /><span>I agree to Sella&apos;s <Link href="/seller-terms" target="_blank" className="font-bold text-kola underline">Seller Terms of Use</Link> and <Link href="/seller-privacy" target="_blank" className="font-bold text-kola underline">Seller Privacy & Anti-Piracy Policy</Link>, including the seller plan options, commission rates, seller responsibilities, and anti-piracy rules.</span></label>
