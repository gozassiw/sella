...
function getConfig() {
  ...
  if (!publicKey || !encryptionKey) {
    throw new Error("TransactPay public key and encryption key are not configured for virtual accounts");
  }
...
export function providerConfigured() {
  return Boolean(process.env.TRANSACTPAY_PUBLIC_KEY && process.env.TRANSACTPAY_ENCRYPTION_KEY);
}
