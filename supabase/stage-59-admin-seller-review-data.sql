-- Sella Stage 59: expose complete seller verification data to platform admins.
-- This remains behind is_platform_admin() and is used only by the Admin workspace.
